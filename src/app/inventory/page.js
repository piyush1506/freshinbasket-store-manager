        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="px-3.5 py-2.5 bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 rounded-xl text-xs font-bold text-slate-700 dark:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all cursor-pointer"
            >
          ...
          {[
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-xl text-xs font-bold shrink-0 transition-all cursor-pointer ${
                stockFilter === tab.id
                  ? "bg-blue-600 dark:bg-blue-600 text-white shadow-sm shadow-blue-500/20"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-baseline gap-2 mt-2">
                        ...
                        <button
                          ...
                          className="text-xs font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 flex items-center gap-1 ml-auto px-2 py-0.5 bg-blue-50 dark:bg-blue-950/40 rounded-lg transition-colors cursor-pointer"
                          title="Edit Rate"
                        >
                          <Edit2 size={11} />
                          <span>Rate</span>
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={(e) => { e.stopPropagation(); setEditingProduct(product); setNewPrice(product.price?.toString() || ""); }}
                            className="p-1 text-slate-500 hover:text-blue-600 dark:text-zinc-400 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-zinc-800 rounded-md transition-colors cursor-pointer"
                            title="Edit Rate"
                          >
                            <Edit2 size={12} />
                          </button>
